...
export default async function RootLayout({
  ...
  // Read maintenance mode header injected by middleware
  const isMaintenanceFromMiddleware = headersList.get('x-maintenance') === '1'
    ...
    <html lang="en" className="dark" suppressHydrationWarning>
      ...
      <body className="min-h-screen bg-background text-foreground font-sans antialiased transition-colors duration-200">
        ...
        <ThemeProvider>
          <I18nProvider>
            <PreloaderWrapper />
            <MaintenanceOverlay forceShow={isMaintenanceFromMiddleware} />
