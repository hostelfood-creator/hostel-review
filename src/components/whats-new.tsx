...
const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2025-07-01',
    highlights: [
      { type: 'feature', text: 'See how your ratings compare week-over-week with new comparison cards' },
      { type: 'feature', text: 'Rating heatmap — discover which meals score best on each day of the week' },
      { type: 'improvement', text: '"What\'s New" section — easily stay up-to-date with the latest improvements' },
    ],
  },
  {
    version: '1.4.0',
    date: '2025-06-25',
    highlights: [
      { type: 'feature', text: 'Pull-to-refresh — swipe down on your dashboard to quickly refresh data' },
      { type: 'feature', text: 'Complaint tracking — see priority levels and estimated resolution times' },
      { type: 'improvement', text: 'Better accessibility — screen reader support and keyboard navigation' },
      { type: 'improvement', text: 'Notifications now sync across all your devices' },
    ],
  },
  {
    version: '1.3.0',
    date: '2025-06-15',
    highlights: [
      { type: 'feature', text: 'Your hostel block now has its own dedicated meal menu' },
      { type: 'improvement', text: 'Faster page loads and a cleaner look' },
    ],
  },
  {
    version: '1.2.0',
    date: '2025-06-05',
    highlights: [
      { type: 'security', text: 'Improved login security for your account protection' },
      { type: 'improvement', text: 'Overall performance and stability improvements' },
    ],
  },
  {
    version: '1.1.0',
    date: '2025-05-20',
    highlights: [
      { type: 'feature', text: 'QR code meal check-in — scan to mark your attendance' },
      { type: 'feature', text: 'Multi-language support — switch between English, Hindi, and Telugu' },
    ],
  },
]
